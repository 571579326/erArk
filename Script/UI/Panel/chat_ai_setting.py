...
class Chat_Ai_Setting_Panel:
    ...
    def change_setting(self, cid, option_len):
        ...
        if cid == 5:
            ...
            ask_text += _("  gpt模型示例：gpt-3.5-turbo, gpt-4, gpt-4-turbo, gpt-4o, gpt-4o-mini, gpt-4.1, o4-mini\n")
            ask_text += _("  deepseek模型示例：deepseek-chat,deepseek-reasoner\n")
            ask_text += _("  gemini模型示例：gemini-1.5-pro, gemini-1.5-flash，gemini-2.0-flash-exp, gemini-2.5-flash, gemini-2.5-pro\n")
